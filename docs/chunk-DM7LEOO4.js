import{i as E}from"./chunk-QZNYCNOS.js";import{$a as b,Ca as f,Ga as h,Ob as w,Za as p,_a as a,fb as y,gb as x,hb as v,ib as Q,kb as l,ta as g}from"./chunk-GHOK36I6.js";var M=["mapContainer"],C=class m{constructor(t){this.router=t}router;quadrants=[];singleQuadrant;mapHeight="450px";mapContainer;map;esc(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}photosHtml(t){let n=t.imagenAntes,o=t.imagenDespues,r=(e,i)=>`
        ...
        "></div>`,iconSize:[24,24],iconAnchor:[12,12]})};if(this.singleQuadrant){let e=this.centerOf(this.singleQuadrant);L.marker(e,{icon:s(this.singleQuadrant.statusColor)}).addTo(this.map).bindPopup(`
      ...
      `).openPopup()}else this.quadrants.forEach(e=>{if(e.lat===void 0||e.lng===void 0)return;let i=[e.lat,e.lng],c=L.marker(i,{icon:s(e.statusColor)}).addTo(this.map),d=document.createElement("div");d.style.fontFamily="sans-serif",d.style.padding="4px",d.style.maxWidth="240px",d.innerHTML=`
